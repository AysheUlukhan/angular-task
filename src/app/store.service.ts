...
//         const store = data.stores.find(store => store.id === storeId);
//         if (store) {
//           const productIndex = store.products.findIndex(product => product.id === updatedProduct.id);
//           if (productIndex !== -1) {
